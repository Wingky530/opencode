...
export const Definitions = {
  ...
  tasks_toggle: keybind("ctrl+y", "Toggle background task tray"),
  tasks_select_next: keybind("none", "Select next task in tray"),
  tasks_select_prev: keybind("none", "Select previous task in tray"),
  tasks_cancel: keybind("none", "Cancel selected task"),
  tasks_close: keybind("none", "Close task tray"),
...
export const CommandMap = {
  ...
  tasks_toggle: "session.tasks.toggle",
  tasks_select_next: "session.tasks.next",
  tasks_select_prev: "session.tasks.prev",
  tasks_cancel: "session.tasks.cancel",
  tasks_close: "session.tasks.close",
